...
exec(open(os.path.join("marrow", "logging", "release.py")).read())
...
setup(
        ...
        description = "A highly efficient and modular logging framework for Python 2.6+ and 3.1+.",
        long_description = """\
For full documentation, see the README.textile file present in the package,
or view it online on the GitHub project page:

https://github.com/marrow/marrow.logging""",
        
        author = "Alice Bevan-McGregor",
        author_email = "alice+marrow@gothcandy.com",
        url = "https://github.com/marrow/marrow.logging",
        license = "MIT",
